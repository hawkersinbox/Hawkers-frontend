...
class _AddCommunityState extends State<AddCommunity> {
  ...
  _addCommunity() async {
    ...
    if (_mobile != '' && _email != '' && _communityname != '' && _alternateMobile != '' &&
        _city != '' && _state != '' && _streetAddress != '' &&
        _pincode != '' && _availableDays!='' && _maxShopCount!='') {
      String body = json.encode({
        "type":_communityname,
        "contact_person":_alternateMobile,
      ...
      final response =
      await Provider.of<Community>(context, listen: false).addCommunity(body);
      setState(() {
        loading = false;
      });
      if (response == true) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Add Community',style:TextStyle(
            fontSize: 24,
