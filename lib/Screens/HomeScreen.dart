...
var gridViewList = [
  {"footer": "Sales Request", "image": "assets/icons/sales_requests.png"},
  {"footer": "Communities", "image": "assets/icons/communities.png"},
  {"footer": "Approval", "image": "assets/icons/approval.png"},
  {"footer": "Add User", "image": "assets/icons/add_users.png"},
  {"footer": "Products", "image": "assets/icons/products.png"},
  {"footer": "Add Payment", "image": "assets/icons/payments.png"},
];
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void salesRequestClicked(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => SalesRequest()));
  }
  ...
  void approvalClicked(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => AdminApproval()));
  }

  void addUserClicked(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => AddUserAdmin()));
  }
